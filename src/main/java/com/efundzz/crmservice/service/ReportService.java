    ...
    public Workbook generateLeadsDataExcel(List<CRMAppliacationResponseDTO> leadsList, String loanType) {
        ...
        if ("PersonalLoan".equals(loanType)) {
            headers = new String[]{"RefNumber", "Application Date", "PIN Code", "Name", "Phone number", "Email id", "Loan Amount", "Type of Loans", "Loan Status", "Pan","takeHomeSalaryMonthly", "purposeOfLoan", "employmentType", "dob", "adhaar", "gender", "currentAddress", "addressAsPerAdhaar", "residentType",
                    "referenceName", "referenceMobile","CreditScore","TotalEmiPaying","NumberOfDependents","OtherFamilyEarnings","AlterNateMobileNumber","CurrentOrganization","JobStability"};
            ...
            headers = new String[]{"RefNumber", "Application Date", "PIN Code", "Name", "Phone number", "Email id", "Loan Amount", "Type of Loans", "Loan Status","Pan","businessIndustry", "gstNumber", "sameAsGst", "businessName", "annualTurnover", "proprietorName", "addressAsPerGST", "grossTotalIncome"
                    , "registrationDate", "currentBusinessAddress", "referenceMobile", "creditScore", "profitAfterTax", "yearsInBusiness","nameOfTheCard","panHolderStatus","BusinessName","gstinUINStatus","businessConstitution","annualTurnover","yearsInBusiness","profitAfterTax","partners"};
        } else {
        ...
        for (int rowIndex = 0; rowIndex < leadsList.size(); rowIndex++) {
            ...
            if ("PersonalLoan".equals(loanType)) {
                ...
                dataRow.createCell(22).setCellValue(data.containsKey("totalEmi") ? String.valueOf(data.get("totalEmi")) : "");
                dataRow.createCell(23).setCellValue(data.containsKey("numberOfDependents") ? String.valueOf(data.get("numberOfDependents")) : "");
                dataRow.createCell(24).setCellValue(data.containsKey("otherFamilyEarning") ? String.valueOf(data.get("otherFamilyEarning")) : "");
                dataRow.createCell(25).setCellValue(data.containsKey("alternateMobile") ? String.valueOf(data.get("alternateMobile")) : "");
                dataRow.createCell(26).setCellValue(data.containsKey("currentOrganization") ? String.valueOf(data.get("currentOrganization")) : "");
                dataRow.createCell(27).setCellValue(data.containsKey("jobStability") ? String.valueOf(data.get("jobStability")) : "");
            } else if ("BusinessLoan".equals(loanType) || "StartupLoan".equals(loanType)) {
                ...
                dataRow.createCell(24).setCellValue(data.containsKey("nameOfTheCard") ? String.valueOf(data.get("nameOfTheCard")) : "");
                dataRow.createCell(25).setCellValue(data.containsKey("panHolderStatus") ? String.valueOf(data.get("panHolderStatus")) : "");
                dataRow.createCell(26).setCellValue(data.containsKey("businessName") ? String.valueOf(data.get("businessName")) : "");
                dataRow.createCell(27).setCellValue(data.containsKey("gstinUINStatus") ? String.valueOf(data.get("gstinUINStatus")) : "");
                dataRow.createCell(28).setCellValue(data.containsKey("businessConstitution") ? String.valueOf(data.get("businessConstitution")) : "");
                dataRow.createCell(29).setCellValue(data.containsKey("annualTurnover") ? String.valueOf(data.get("annualTurnover")) : "");
                dataRow.createCell(30).setCellValue(data.containsKey("yearsInBusiness") ? String.valueOf(data.get("yearsInBusiness")) : "");
                dataRow.createCell(31).setCellValue(data.containsKey("profitAfterTax") ? String.valueOf(data.get("profitAfterTax")) : "");
                dataRow.createCell(32).setCellValue(data.containsKey("partners") ? String.valueOf(data.get("partners")) : "");
